...
pub mod Errors {
    ...
    ///
    /// ```text
    ///0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea2646970667358221220ff28e301017a9424c1274c94a8434c7284759f72d0e1582a913f8456f414815964736f6c634300081e0033
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R4`\x1DW`\x0E`!V[`>`,\x8290\x81PP`>\x90\xF3[`'V[`@Q\x90V[_\x80\xFD\xFE`\x80`@R_\x80\xFD\xFE\xA2dipfsX\"\x12 \xFF(\xE3\x01\x01z\x94$\xC1'L\x94\xA8CLr\x84u\x9Fr\xD0\xE1X*\x91?\x84V\xF4\x14\x81YdsolcC\0\x08\x1E\x003",
    );
    /// The runtime bytecode of the contract, as deployed on the network.
    ///
    /// ```text
    ///0x60806040525f80fdfea2646970667358221220ff28e301017a9424c1274c94a8434c7284759f72d0e1582a913f8456f414815964736f6c634300081e0033
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static DEPLOYED_BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R_\x80\xFD\xFE\xA2dipfsX\"\x12 \xFF(\xE3\x01\x01z\x94$\xC1'L\x94\xA8CLr\x84u\x9Fr\xD0\xE1X*\x91?\x84V\xF4\x14\x81YdsolcC\0\x08\x1E\x003",
    );
