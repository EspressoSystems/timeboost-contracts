...
```solidity
interface ERC1967UpgradeUpgradeable {
...
pub mod ERC1967UpgradeUpgradeable {
    use super::*;
...
```*/
    ...
    ///Container for all the [`ERC1967UpgradeUpgradeable`](self) events.
    #[derive(serde::Serialize, serde::Deserialize)]
    ...
    #[automatically_derived]
    impl ERC1967UpgradeUpgradeableEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC1967UpgradeUpgradeableEvents {
        const NAME: &'static str = "ERC1967UpgradeUpgradeableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC1967UpgradeUpgradeableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`ERC1967UpgradeUpgradeable`](self) contract instance.

See the [wrapper's documentation](`ERC1967UpgradeUpgradeableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC1967UpgradeUpgradeableInstance<P, N> {
        ERC1967UpgradeUpgradeableInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC1967UpgradeUpgradeableInstance<P, N>>,
    > {
        ERC1967UpgradeUpgradeableInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ERC1967UpgradeUpgradeableInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`ERC1967UpgradeUpgradeable`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC1967UpgradeUpgradeable`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC1967UpgradeUpgradeableInstance<
        P,
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ERC1967UpgradeUpgradeableInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC1967UpgradeUpgradeableInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC1967UpgradeUpgradeableInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ERC1967UpgradeUpgradeableInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC1967UpgradeUpgradeableInstance<P, N> {
            ERC1967UpgradeUpgradeableInstance {
